...
import com.example.renatogallis.fixcard.Usuario;
...
public Scripts_Table_Usuarios(Context context){db_usuarios = new DataBase_Usuarios(context);}
    ...
    public List<Usuario> getUsuari_Cadastradi_App(){
        List<Usuario> usuarios_Cadastrados =  new LinkedList<>();
